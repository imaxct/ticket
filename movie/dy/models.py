...
class Movie(models.Model):
    ...
    moviename = models.CharField(db_column='movieName', max_length=100, blank=True, null=True)  # Field name made lowercase.
    totaltime = models.TimeField(db_column='totalTime', blank=True, null=True)  # Field name made lowercase.
    type = models.CharField(max_length=100, blank=True, null=True)
    actor = models.CharField(max_length=100, blank=True, null=True)
    derictor = models.CharField(max_length=100, blank=True, null=True)
...
class Ticket(models.Model):
    ...
    seatid = models.CharField(db_column='seatID', max_length=100, blank=True, null=True)  # Field name made lowercase.
