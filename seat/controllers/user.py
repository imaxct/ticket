...
def oauth(request):
    ...
    try:
        ...
        user = User(
            ...
            nickname=bytes.decode(base64.urlsafe_b64encode(str.encode(user_info['nickname']))),
...
def mine(request):
    ...
    user.nickname = bytes.decode(base64.urlsafe_b64decode(str.encode(user.nickname)))
